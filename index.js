...
*/
                ...
                if (!isRegistered) return reply( ind.noregis())
					...
					baby.sendMessage(from, '*тЮ╕ Jawaban :* '+anu.jawaban+ '\n\nтАв Penjelasan: *'+ anu.keterangan+'*', text, {quoted: mek }) // ur cods

					}, 30000) // 1000 = 1s,

					setTimeout( () => {

					baby.sendMessage(from, '_10 Detik lagiтАж_', text) // ur cods

					}, 20000) // 1000 = 1s,

					setTimeout( () => {

					baby.sendMessage(from, '_20 Detik lagi_тАж', text) // ur cods

					}, 10000) // 1000 = 1s,

					setTimeout( () => {

					baby.sendMessage(from, '_30 Detik lagi_тАж', text) // ur cods

					}, 2500) // 1000 = 1s,

					setTimeout( () => {

					baby.sendMessage(from, caklontong, text, {quoted: mek }) // ur cods
...
*/				
            ...
            case 'creator':
                  ...
                  baby.sendMessage(from, 'Ini owner saya Jangan lupa subscribe abdulaziz albaihaqi...',MessageType.text, { quoted: mek} )
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					setTimeout( () => {
					 ...
					 client.sendMessage(from, 'SIAP SIAP REM BOT KICK NIH', text, { quoted: mek }) // ur cods
...
if (budy.includes(`@6285694347823`)) {



                  reply(`Jangan Tag abay Kak, Dia Lagi Sibuk ✨`)
...
if (budy.includes(`@6285694347823`)) {
                  ...
                  reply(`Jangan abay Kak, Dia Lagi Sibuk ✨`)
